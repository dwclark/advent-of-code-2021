...
;;This is the main trick. Each turn generates 27 quantum worlds. However, there are only seven
;;possible scores for those worlds, and each of those scores generates a fixed number of
;;quantum worlds. These are the scores and number of worlds. You could probably write some
;;code to generate it, but it was easier just to spend a couple of minutes tallying them
;;up with pencil and papter. Then, play quantum just uses these values to tally up scores
;;and keep track of the number of worlds generated by all previous combinations of scores
